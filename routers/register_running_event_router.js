...
const { create_event, getAll, getbyId, getregbyOrganizer, uploadimg_event, update_status_event, update_event } = require('../controllers/register_running_event_controller.js')
const { auth_mdw } = require('../middleware/auth.mdw.js')
router.post('/reg-event/create', auth_mdw, create_event)
router.post('/reg-event/update', auth_mdw, update_event)
...
router.post('/reg-event/update-status-event', auth_mdw, update_status_event)
